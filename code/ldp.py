...
'''
This is an object that simply allows us to encode, perturb, and aggregate 
an inputted trajectory. Utilizing the OUE protocol is LDPTrace's implementation 
of local differential privacy. This implementation is entirely dependent on 
bitwise operations.
...
'''
    Object: OUEServer
    This is just protocol/possible actions for the data curator (ie, some 
    aggregator) that exists in a server 
...
''' 
    Object: OUEClient
    This is the object that represents the end user (ie, the person that is actually
