...
class Grid:
    def __init__(self,
        ...
        """
        # CHANGELOG
        - Added an instance variable that represents the angle of the grid object
        ...
        # Center values to be utilized for the perturbation process
        self.center_x = min_x + 0.5 * step_x
        self.center_y = min_y + 0.5 * step_y
